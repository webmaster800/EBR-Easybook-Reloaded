        ...
        <div id="editcell">
            <table class="adminlist">
                ...
                for($i = 0; $i < $n; $i++)
                {
                    ...
                    $link = JRoute::_('index.php?option=com_easybookreloaded&controller=entrygb&task=edit&cid[]='.$row->id);
                    ?>
                    <tr class="<?php echo "row$k"; ?>">
                        ...
                        <td>
                        <span class="hasTip" title="<?php echo $row->title ?>">
                        ...
                        <td>
                        <span class="hasTip" title="<?php echo $row->introtext ?>">
                            <?php
                            if(strlen($row->introtext) > 165)
                            {
                                echo substr(strip_tags(htmlspecialchars_decode($row->introtext)), 0, 165)."...";
                            }
                            else
                            {
                                echo strip_tags(htmlspecialchars_decode($row->introtext));
                            }
                            ?>
                        </span>
                        </td>
